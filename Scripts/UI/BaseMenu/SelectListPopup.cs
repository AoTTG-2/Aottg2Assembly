...
namespace UI
{
    class SelectListPopup: PromptPopup
    {
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            _noItemsLabel = ElementFactory.CreateDefaultLabel(SinglePanel, new ElementStyle(themePanel: ThemePanel), UIManager.GetLocale(cat, sub, "NoItems"));
        }
