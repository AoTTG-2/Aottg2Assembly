...
namespace UI
{
    class CreateGamePopup: BasePopup
    {
        ...
        protected override void SetupTopButtons()
        {
            ...
            foreach (string buttonName in new string[] { "General", "Mode", "Titans", "Weather", "Misc", "CustomMap" })
            {
        ...
        private void StartRoom()
        {
            ...
            string difficulty = ((GameDifficulty)settings.General.Difficulty.Value).ToString();
            ...
            roomName = string.Join("`", new string[] { roomName, mapName, difficulty, password, UnityEngine.Random.Range(0, 100000).ToString()});
            PhotonNetwork.CreateRoom(roomName, roomOptions, new TypedLobby());
        }
