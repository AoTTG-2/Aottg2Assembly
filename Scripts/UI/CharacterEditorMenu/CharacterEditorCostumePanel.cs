    ...
    class CharacterEditorCostumePanel: HeadedPanel
    {
        ...
        public override void Setup(BasePanel parent = null)
        {
            ...
            ElementFactory.CreateDropdownSetting(SinglePanel, style, set.Face, UIManager.GetLocale(cat, sub, "Face"), GetOptionNames("Face", 13, true), 
                elementWidth: dropdownWidth, onDropdownOptionSelect: () => _menu.ResetCharacter());
            ElementFactory.CreateDropdownSetting(SinglePanel, style, set.Glass, UIManager.GetLocale(cat, sub, "Glass"), GetOptionNames("Glass", 10, true), 
                elementWidth: dropdownWidth, onDropdownOptionSelect: () => _menu.ResetCharacter());
            ElementFactory.CreateDropdownSetting(SinglePanel, style, set.Hair, UIManager.GetLocale(cat, sub, "Hair"), GetHairOptionNames(10, 10), 
                elementWidth: dropdownWidth, onDropdownOptionSelect: () => _menu.ResetCharacter());
            ElementFactory.CreateDropdownSetting(SinglePanel, style, set.Skin, UIManager.GetLocale(cat, sub, "Skin"), GetOptionNames("Skin", 2), 
                elementWidth: dropdownWidth, onDropdownOptionSelect: () => _menu.ResetCharacter());
            ElementFactory.CreateDropdownSetting(SinglePanel, style, set.Costume, UIManager.GetLocale(cat, sub, "Costume"), GetOptionNames("Costume", 10), 
                elementWidth: dropdownWidth, onDropdownOptionSelect: () => _menu.ResetCharacter());
            ElementFactory.CreateDropdownSetting(SinglePanel, style, set.Cape, UIManager.GetLocale(cat, sub, "Cape"), new string[] {"No cape", "Cape"}, 
                elementWidth: dropdownWidth, onDropdownOptionSelect: () => _menu.ResetCharacter());
            ElementFactory.CreateDropdownSetting(SinglePanel, style, set.Logo, UIManager.GetLocale(cat, sub, "Logo"), GetOptionNames("Logo", 3), 
                elementWidth: dropdownWidth, onDropdownOptionSelect: () => _menu.ResetCharacter());
