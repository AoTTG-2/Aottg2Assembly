...
namespace Characters
{
    class HumanSetup: MonoBehaviour
    {
        ...
        public void Copy(InGameCharacterSettings settings)
        {
            ...
            CustomSet = (HumanCustomSet)customSets.Sets.GetItemAt(settings.CustomSet.Value);
        ...
        public void Create3dmg()
        {
            ...
            _part_gas_l = ResourceManager.InstantiateAsset<GameObject>("Character/" + _meshes.GetGasMesh(left: true));
            ...
            _part_gas_r = ResourceManager.InstantiateAsset<GameObject>("Character/" + _meshes.GetGasMesh(left: false));
        ...
        public void CreateWeapon()
        {
            ...
            if (Weapon == HumanWeapon.Gun || Weapon == HumanWeapon.Blade)
            {
                ...
                {
                    _part_blade_l = ResourceManager.InstantiateAsset<GameObject>("Character/" + weaponLMesh);
                ...
                {
                    _part_blade_r = ResourceManager.InstantiateAsset<GameObject>("Character/" + weaponRMesh);
        ...
        public void CreateHair()
        {
            ...
            if (hairMesh != string.Empty)
            {
                ...
                _part_hair.renderer.material.color = CustomSet.HairColor.Value;
            }
            ...
            if (hairClothMesh != string.Empty && !IsDeadBody)
            {
                ...
                _part_hair_1 = ClothFactory.GetHair(_mount_cloth, "Character/" + hairClothMesh, material, CustomSet.HairColor.Value);
            }
        }
        ...
        public void CreateUpperBody()
        {
            ...
            if (CurrentCostume["Type"].ToString().StartsWith("Uniform"))
            {
