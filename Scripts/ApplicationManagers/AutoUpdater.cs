...
{
    /// <summary>
    /// Manages auto-updating and integrity checks. 
    /// This is the first manager run and blocks the game until complete.
    /// Autoupdate can be disabled by creating a "DevelopmentConfig" file in the data folder.
    /// </summary>
