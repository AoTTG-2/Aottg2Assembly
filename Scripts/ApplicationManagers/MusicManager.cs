...
namespace ApplicationManagers
{
    public class MusicManager : MonoBehaviour
    {
        ...
        private static void OnLoadScene(SceneName sceneName)
        {
            if (sceneName == SceneName.MainMenu || sceneName == SceneName.MapEditor || sceneName == SceneName.CharacterEditor)
                SetPlaylist(MusicPlaylist.MainMenu);
            else if (sceneName == SceneName.InGame)
                SetPlaylist(MusicPlaylist.InGameDefault);
        }
        ...
        public static void NextSong()
        {
            ...
            var songInfo = playlist[Random.Range(0, playlist.Count)];
            SetSong(songInfo);
        }
        ...
        {
            return SettingsManager.GeneralSettings.Music.Value;
        }
    }
    ...
    public class MusicPlaylist
    {
        ...
        public static string InGameDefault = "InGameDefault";
        public static string InGameBoss = "InGameBoss";
        public static string InGamePeaceful = "InGamePeaceful";
    }
}