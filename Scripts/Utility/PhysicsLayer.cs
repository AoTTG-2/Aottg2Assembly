...
namespace Utility
{
    class PhysicsLayer
    {
        ...
        public static void Init()
        {
            ...
            SetLayerCollisions(TitanPushbox, new int[] { Hitbox, Human, Projectile });
            ...
            SetLayerCollisions(MapObjectCharacters, new int[] { MapObjectAll, Human, TitanMovebox });
            SetLayerCollisions(MapObjectEntities, new int[] { MapObjectAll, TitanMovebox, Human, Projectile });
            SetLayerCollisions(MapObjectAll, new int[] { Human, TitanMovebox, Projectile, MapObjectAll, MapObjectMapObjects, MapObjectEntities, 
                MapObjectCharacters, MapObjectProjectiles});
